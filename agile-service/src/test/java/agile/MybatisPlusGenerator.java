...
public class MybatisPlusGenerator {
    ...
    private static final String DB_URL = "jdbc:mariadb://120.79.227.16:9630/misa?characterEncoding=utf8";
    private static final String DB_USER = "root";
    private static final String DB_PASS = "maywide_123";
    private static final String DIR = "/src/main/java";
    private static final String BASE_PACKAGE = "agile.service";
    private static final String AUTHOR = "Alex";
    ...
    public void generate() throws IOException {
        ...
        strategy.setTablePrefix(new String[] { "sys_", "app_" });// 此处可以修改为表前缀
        strategy.setNaming(NamingStrategy.underline_to_camel);// 表名生成策略
        strategy.setInclude(new String[] { "sys_user", "sys_role", "sys_user_role" }); // 需要生成的表
        // strategy.setExclude(new String[] { "table_name" }); // 排除生成的表
        // 字段名生成策略
        strategy.setControllerMappingHyphenStyle(true);
        strategy.setLogicDeleteFieldName("status");
        strategy.setDbColumnUnderline(true);
        // 自定义实体父类
        strategy.setSuperEntityClass("agile.common.entity.AuditingEntity");
        // 自定义实体，公共字段
        ...
        // 自定义 controller 父类
        strategy.setSuperControllerClass("agile.common.controller.AgileRestController");
